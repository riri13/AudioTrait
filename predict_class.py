...
def predict_one(signal, sr, model, expected_melgram_shape, class_names): #, weights_file="weights.hdf5"):
...
def main(args):
    ...
    for infile in args.file:
        if os.path.isfile(infile):
            ...
            y_proba = predict_one(signal, sr, model, expected_melgram_shape, class_names) 
